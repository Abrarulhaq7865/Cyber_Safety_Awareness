...
const weeks = [
  ...
  },
  {
    ...
    activities: [
      'Prepared Telugu-English bilingual threats and tips on phishing & OTP fraud',
      'Created display charts on Top 10 Cyber Safety Tips',
      'Conducted community awareness survey (35+ residents)',
      'Door-to-door surveys with people and direct counselling',
