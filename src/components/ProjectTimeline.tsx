...
const weeks = [
  ...
  },
  {
    ...
    activities: [
      'Designed and finalized a large bilingual display banner featuring the "Top 10 Cyber Safety Tips".',
      'Mapped out high-traffic public gathering spots, local shops, and tea stalls across the village.',
      'Positioned the educational banner at central hubs to attract the attention of passing residents.',
      'Initiated casual street-level interactions with small groups of villagers using the display banner.',
  ...
  },
  {
    ...
    activities: [
      'Conducted community sessions explaining fake job offers, lottery prizes, and fraudulent reward scams.',
      'Educated residents on identifying phone-based vishing attacks and pretending tele-caller threats.',
      'Demonstrated the importance of digital literacy, strong password creation, and securing banking accounts.',
      'Taught community members how to review and restrict risky smartphone app permissions like camera, microphone, and location.',
