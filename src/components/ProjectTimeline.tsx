...
const weeks = [
  ...
  },
  {
    ...
    activities: [
      'Coordinated with school headmaster for dedicated sessions',
      'Upper primary students: cyberbullying, safe gaming, social media',
      'Lower primary: pictorial charts and stories on safe internet',
      'Taught students how to report cyberbullying',
      'Parent awareness on monitoring and parental controls',
      'Cyber safety quiz — top performers received certificates',
    ],
  ...
  },
  {
    ...
    bgColor: 'bg-cyber-primary/5',
    activities: [
      'Identified and recruited 5 community youth as Ambassadors',
      'Training on phishing, password security, OTP fraud, social engineering',
      'Ambassadors conducted first independent mini-session for village women',
      'Community Cyber Safety Quiz Competition (60+ participants)',
      'Awarded certificates to quiz winners and ambassadors',
      'Final open Q&A session — all community doubts addressed',
    ],
