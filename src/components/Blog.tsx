...
              return (
                <div key={article.id} className="glass-card-hover overflow-hidden">
...
                    <h3 className="text-base font-bold text-cyber-text mb-2 leading-snug hover:text-cyber-primary transition-colors cursor-pointer">
                      {article.title}
                    </h3>
...
                        ))}
                      </div>
                      <button className="flex items-center gap-1 text-xs text-cyber-primary hover:gap-2 transition-all">
