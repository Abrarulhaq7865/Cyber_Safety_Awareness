...
// NEW: mapping category -> authoritative resource URL
const categoryLinks: Record<string, string> = {
  'AI Scams': 'https://www.cert-in.org.in/',
  'UPI Safety': 'https://www.npci.org.in/what-we-do/upi/product-overview/safety-and-security',
  'Latest Threats': 'https://www.cert-in.org.in/',
  'Online Privacy': 'https://www.meity.gov.in/',
  'Digital Literacy': 'https://www.pmgdisha.in/'
};
                ...
                <div key={article.id} className="group glass-card-hover overflow-hidden flex flex-col justify-between">
                  <div>
                    ...
                    <div className="p-5">
                      ...
                      {/* Title still opens modal (optional) */}
                      <h3 
